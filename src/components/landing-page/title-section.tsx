  ...
  return (
    <React.Fragment>
      <section className="flex flex-col gap-4 justify-center items-start md:items-center">
        ...
        {subheading ? (
          <>
            <h2 className="text-left text-3xl sm:text-5xl sm:max-w-[750-px] md:text-center font-semibold ">
              {title}
            </h2>
            <p className="dark:text-wash-purple-700 sm:max-w-[450px]md:text-center">
              {subheading}
            </p>
          </>
        ) : (
